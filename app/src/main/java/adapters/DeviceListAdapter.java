...
public class DeviceListAdapter extends RecyclerView.Adapter<DeviceListAdapter.ViewHolder> implements Filterable, ItemTouchMoveListener {
    ...
    @Setter private int _selectedPos = -1;
    private View _view;
    BluetoothItemSelectListener _selectListener;
    private boolean _isClickable = true;

    public DeviceListAdapter(List<BluetoothDevice> devices, FloatingActionButton fab, BluetoothItemSelectListener selectListener){
        _devices = devices;
        ...
        ViewHolder(final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    _selectListener.onClick(BluetoothController.getInstance().getBondedDevices().get(_selectedPos));
                }
            });
        }
    }
