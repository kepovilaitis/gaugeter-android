...
public class PreferenceKeys {
    ...
    public final static String PREFERENCE_ALERT_ENABLED = "soundPref";
    public final static String PREFERENCE_ALERT_SOUND_URI = "alertSoundUri";
    ...
    public final static String PREFERENCE_UNLOCK_ALERT_DISTANCE = "unlockAlertDistancePref";
    public final static String PREFERENCE_LOW_BATTERY_ALERT = "lowBatteryAlertPref";
    public final static String PREFERENCE_WEBASTO = "webastoPref";
    public final static String PREFERENCE_PHONE_NUMBER = "phoneNumberPref";
    public final static String PREFERENCE_PASSWORD = "passwordPref";
    public final static String PREFERENCE_SMS_COUNT = "smsCountPref";
    public final static String PREFERENCE_SMS_WEBASTO = "smsWebastoPref";
    public final static String PREFERENCE_FUEL_MORE_INFO = "fuelMoreInfoPref";
